                    ...
                    <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
                        ...
                        <div className="max-w-4xl mx-auto">
                            <p className="text-xl text-teal-800">
                                A holistic approach to reduce Green House Gas
                                emissions for firms/ local govt bodies around
                                the world. We leverage econometric ML models to
                                study clients' entire value chain to offer e2e
                                solution in reducing carbon footprint. How are
                                we different:
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="">
                        <div className="grid grid-cols-1 sm:grid-cols-3 sm:gap-x-4 gap-y-4">
                            <div className="swiper-slide h-auto flex flex-col bg-teal-900 opacity-80 p-6 rounded">
                                ...
                                {/*  <a className="font-medium text-emerald-600 inline-flex items-center transition duration-150 ease-in-out group" href="#0">*/}
                                {/*    Learn More{' '}*/}
                            ...
                            <div className="swiper-slide h-auto flex flex-col bg-teal-900 opacity-80 p-6 rounded">
                                ...
                                <div className="grow">
                                    ...
                                    <div className="text-teal-600 mb-3">
                                        Market Mix Modelling (MMM) to help CXO's
                                        visualize efficiency of their marketing
                                        spend
                                    </div>
                                </div>
                                {/*<div className="text-right">*/}
